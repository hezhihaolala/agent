...
class Person(Base):
    ...
    courtesy_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    art_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    aliases: Mapped[str | None] = mapped_column(String(200), nullable=True)
    generation_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    family_rank: Mapped[str | None] = mapped_column(String(100), nullable=True)
...
class Relationship(Base):
    ...
    sibling_type: Mapped[str | None] = mapped_column(String(20), nullable=True)
    verification_status: Mapped[str] = mapped_column(String(30), default="unverified")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True))
